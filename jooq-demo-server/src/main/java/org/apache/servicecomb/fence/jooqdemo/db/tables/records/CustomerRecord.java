...
public class CustomerRecord extends UpdatableRecordImpl<CustomerRecord> {
     ...
     */
    public CustomerRecord(Long customerId, Long storeId, String firstName, String lastName, String email, Long addressId, Boolean activebool, LocalDateTime createDate, LocalDateTime lastUpdate, Integer active) {
        super(Customer.CUSTOMER);
     ...
     * Create a detached, initialised CustomerRecord
     */
    public CustomerRecord(org.apache.servicecomb.fence.jooqdemo.db.tables.pojos.Customer value) {
        super(Customer.CUSTOMER);
