...
import org.apache.servicecomb.fence.jooqdemo.db.tables.records.PaymentP2007_05Record;
...
public class PaymentP2007_05 extends TableImpl<PaymentP2007_05Record> {
     ...
     */
    public final TableField<PaymentP2007_05Record, Long> PAYMENT_ID = createField(DSL.name("payment_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.payment_p2007_05.customer_id</code>.
     */
    public final TableField<PaymentP2007_05Record, Long> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.payment_p2007_05.staff_id</code>.
     */
    public final TableField<PaymentP2007_05Record, Long> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.payment_p2007_05.rental_id</code>.
     */
    public final TableField<PaymentP2007_05Record, Long> RENTAL_ID = createField(DSL.name("rental_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    @Override
    public Identity<PaymentP2007_05Record, Long> getIdentity() {
        return (Identity<PaymentP2007_05Record, Long>) super.getIdentity();
    }
